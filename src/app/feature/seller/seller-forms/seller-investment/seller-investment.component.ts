...
@Component({
  selector: 'app-seller-investment',
  templateUrl: './seller-investment.component.html',
  styleUrls: ['../seller-forms.component.css']
})
export class SellerInvestmentComponent implements OnInit {
  ...
  req_invest_value: number = 42;
  req_invest_highValue: number = 100;
  req_invest_options: Options = {
    floor: 0,
    ceil: this.req_invest_highValue,
    translate: (value: number): string => {
      return 'AED ' + value + ' Million';
    }
  };
