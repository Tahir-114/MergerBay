...
export class SignUpComponent implements OnInit {
  ...
  public welcome_msg : boolean = false;
  public finised_data:boolean=false;
  ...
  ngOnInit(): void {
    this.signupForm = this.form.initSignupForm()
  }
  get f() {
  ...
  get matchedPassword() { return this.signupForm.get('confirmPassword'); }
  get country() { return this.signupForm.get('country'); }
  get phone() { return this.signupForm.get('phone'); }
  get tc() { return this.signupForm.get('accepted'); }
  userSignUP = async (): Promise<void> => {
    ...
    //let isMatched=this.mustMatch('password','confirmPassword');
    this.submitted=true;
    if(this.matchedPassword?.invalid)
    {
   ...
   this.userAuth
     ...
     .subscribe(
       (data:any) => {
        console.log(data);
        if(data.root!='User already exists')
        {
          this.existingUserMessage='';
          this.welcome_msg=true;
          this.login_page=false;
        }
        this.existingUserMessage=data['root'];
