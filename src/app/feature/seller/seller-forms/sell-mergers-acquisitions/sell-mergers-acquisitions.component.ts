...
@Component({
  selector: 'app-sell-mergers-acquisitions',
  templateUrl: './sell-mergers-acquisitions.component.html',
  styleUrls: ['../seller-forms.component.css']
})
export class SellMergersAcquisitionsComponent implements OnInit {
